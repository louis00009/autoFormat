...
const ComponentB = () => {
  ...
  useEffect(() => {
    ...
    const info = `***Received Invoice: ${vendorInvoiceNumber} from ${vendorName} for ${vendorInvoicePurpose}: $${formatPrice(vendorTotalPriceNoGst)}+ ***PO: ${purchaseOrderNumber}***Raised invoice: ${raisedInvoiceNumber} to ${payoutVendor} for ${vendorInvoicePurpose}: $${formatPrice(
    ...
    const info2 = `***Received Invoice: ${vendorInvoiceNumber} from ${vendorName} for ${vendorInvoicePurpose}: $${formatPrice(vendorTotalPriceNoGst)}+ ***PO: ${purchaseOrderNumber}***Raised invoice: ${raisedInvoiceNumber} to ${payoutVendor} for ${vendorInvoicePurpose}: $${formatPrice(
    ...
    if (payoutPriceWithoutGST === "" || payoutInvoiceTwo === "") {
      ...
      setVendorTotalPrice(Number(payoutPriceWithoutGST) + Number(payoutInvoiceTwo));
    }
    ...
    raisedInvoicePrice,
    salesOrderNumber,
    payoutPriceWithoutGST, payoutInvoiceTwo,
  ]
  ...
  return (
    <div className="container">
      ...
      <div className="text-container">
        ...
        >
          {isCopied
            ...
            : <p style={{ fontSize: '16px',fontWeight:'bold' }}>{componentInfoPO}</p>}
        </p>
      </div>
      <div className="text-container">
        <p
        ...
        >
          {isCopied
            ? "Information successfully copied to the clipboard"
            : <p style={{ fontSize: '16px',fontWeight:'bold' }}>{componentInfoPO2}</p>}
        </p>
      </div>
      ...
      <div className="input-row">
        ...
        <Button type="primary" danger="true" onClick={handleResetPO}>Reset PO</Button>
      {/* <button onClick={handleResetexceptvn}>Reset-Keep VN</button> */}
      <Button type="primary" danger="true" onClick={unsecuredCopyToClipboardPO}>Copy PO(IN-1)</Button>
      <Button type="primary" danger="true" onClick={unsecuredCopyToClipboardPO2}>Copy PO(IN-2)</Button>
      <Table
